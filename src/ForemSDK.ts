import {ArticleObject, ArticleSearchParameters} from './ForemType'

/**
 * Forem SDK / API Wrapper for Forem API version 0.9.7 Beta (Unofficial)
 * Official API documentation: https://developers.forem.com/api 
 * 
 * Call the wrapper by
 * ```
 * const forem = new ForemSDK()
 * // or
 * const forem = new ForemSDK(your_api_key)
 * ```
 */
export class ForemSDK {
  apiKey?: string
